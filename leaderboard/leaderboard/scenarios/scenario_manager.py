...
class ScenarioManager(object):
    ...
    def load_scenario(self, scenario, agent, rep_number):
        ...
        #生成Camera
        self.camera = world.spawn_actor(camera_bp, Camera_transform,attach_to=self.ego_vehicles[0],
    ...
    def _tick_scenario(self, timestamp):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            #设置观察者视图
            # CarlaDataProvider.get_world().get_spectator().set_transform(self.camera.get_transform())
