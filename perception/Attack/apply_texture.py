...
def main():
    ...
    argparser.add_argument(
        ...
        help='Object name')
    # argparser.add_argument(
    #     '-olist', '--object-name-list',
    #     type=list,
    #     help='Object name list')
    argparser.add_argument(
        '-l', '--list',
        action='store_true',
    ...
    # world.apply_textures_to_objects(args.object_name_list, tex_diffuse, carla.TextureFloatColor(0,0), tex_normal, tex_ao_r_m_e)
